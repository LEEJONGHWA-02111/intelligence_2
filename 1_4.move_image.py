# 이미지 데이터를 훈련, 검증, 테스트 세트로 자동으로 분할하는 기능을 수행
# 지정된 비율로 랜덤으로 섞어 데이터 분포를 균등하게 정리함.
...
def split_files(source_directory, train_dir="./amr_my_data/train/images", 
                validation_dir="./amr_my_data/valid/images", 
                test_dir="./amr_my_data/test/images", 
