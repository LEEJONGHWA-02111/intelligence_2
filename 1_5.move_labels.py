# yolo 라벨링 파일(.txt)을 올바른 폴더로 자동 복사하는 기능을 수행
#각 .jpg파일에 대응하는 .txt 라벨 파일을 올바른 폴더로 자동 복사하는 기능을 수행
...
def main():
    source_dir_with_jpg = './amr_my_data/train/images'
    source_dir_with_txt = './amr_txt'
    target_dir = './amr_my_data/train/labels'

    move_corresponding_txt_files(source_dir_with_jpg, source_dir_with_txt, target_dir)

    source_dir_with_jpg = './amr_my_data/valid/images'
    target_dir = './amr_my_data/valid/labels'
